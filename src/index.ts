...
function x86hash32(
  ...
  if (typeof state === 'number') {
    ...
    ({ h1, len } = (state as x86hash32State));
...
function x86mix128(
  h1: u32, h2: u32, h3: u32, h4: u32,
  k1: u32, k2: u32, k3: u32, k4: u32,
): [u32, u32, u32, u32] {
...
function x86hash128(
  ...
  if (typeof state === 'number') {
    ...
    ({ h1, h2, h3, h4, len } = (state as x86hash128State));
    const rem = (state as x86hash32State).rem;
